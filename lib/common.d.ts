...
export declare const flatMessages: (messages?: Record<string, any>) => {
    [key: string]: any;
};
export declare const combineMessages: (originalMessages: Record<string, any>, messages?: Record<string, any>) => void;
